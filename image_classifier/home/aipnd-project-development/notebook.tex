...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{} Imports here}
...
\href{https://s3.amazonaws.com/content.udacity-data.com/nd089/flower_data.tar.gz}{download
it here}. The dataset is split into three parts, training, validation,
and testing. For the training, you'll want to apply transformations such
...
to what the network expects. For the means, it's
\texttt{{[}0.485,\ 0.456,\ 0.406{]}} and for the standard deviations
\texttt{{[}0.229,\ 0.224,\ 0.225{]}}, calculated from the ImageNet
images. These values will shift each color channel to be centered at 0
and range from -1 to 1.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{n}{data\PYZus{}dir} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{flowers}\PY{l+s+s1}{\PYZsq{}}
        ...
        \PY{n}{test\PYZus{}dir} \PY{o}{=} \PY{n}{data\PYZus{}dir} \PY{o}{+} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/test}\PY{l+s+s1}{\PYZsq{}}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{} TODO: Define your transforms for the training, validation, and testing sets}
        \PY{n}{train\PYZus{}transforms} \PY{o}{=} \PY{n}{transforms}\PY{o}{.}\PY{n}{Compose}\PY{p}{(}\PY{p}{[}\PY{n}{transforms}\PY{o}{.}\PY{n}{Resize}\PY{p}{(}\PY{l+m+mi}{256}\PY{p}{)}\PY{p}{,} \PY{n}{transforms}\PY{o}{.}\PY{n}{CenterCrop}\PY{p}{(}\PY{l+m+mi}{224}\PY{p}{)}\PY{p}{,} \PY{n}{transforms}\PY{o}{.}\PY{n}{RandomHorizontalFlip}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{transforms}\PY{o}{.}\PY{n}{ToTensor}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{transforms}\PY{o}{.}\PY{n}{Normalize}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{0.485}\PY{p}{,} \PY{l+m+mf}{0.456}\PY{p}{,} \PY{l+m+mf}{0.406}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mf}{0.229}\PY{p}{,} \PY{l+m+mf}{0.224}\PY{p}{,} \PY{l+m+mf}{0.225}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{)}
        \PY{n}{test\PYZus{}transforms} \PY{o}{=} \PY{n}{transforms}\PY{o}{.}\PY{n}{Compose}\PY{p}{(}\PY{p}{[}\PY{n}{transforms}\PY{o}{.}\PY{n}{Resize}\PY{p}{(}\PY{l+m+mi}{256}\PY{p}{)}\PY{p}{,} \PY{n}{transforms}\PY{o}{.}\PY{n}{CenterCrop}\PY{p}{(}\PY{l+m+mi}{224}\PY{p}{)}\PY{p}{,} \PY{n}{transforms}\PY{o}{.}\PY{n}{ToTensor}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{transforms}\PY{o}{.}\PY{n}{Normalize}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{0.485}\PY{p}{,} \PY{l+m+mf}{0.456}\PY{p}{,} \PY{l+m+mf}{0.406}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mf}{0.229}\PY{p}{,} \PY{l+m+mf}{0.224}\PY{p}{,} \PY{l+m+mf}{0.225}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{)}
        \PY{n}{valid\PYZus{}transforms} \PY{o}{=} \PY{n}{transforms}\PY{o}{.}\PY{n}{Compose}\PY{p}{(}\PY{p}{[}\PY{n}{transforms}\PY{o}{.}\PY{n}{Resize}\PY{p}{(}\PY{l+m+mi}{256}\PY{p}{)}\PY{p}{,} \PY{n}{transforms}\PY{o}{.}\PY{n}{CenterCrop}\PY{p}{(}\PY{l+m+mi}{224}\PY{p}{)}\PY{p}{,} \PY{n}{transforms}\PY{o}{.}\PY{n}{ToTensor}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{transforms}\PY{o}{.}\PY{n}{Normalize}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{0.485}\PY{p}{,} \PY{l+m+mf}{0.456}\PY{p}{,} \PY{l+m+mf}{0.406}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mf}{0.229}\PY{p}{,} \PY{l+m+mf}{0.224}\PY{p}{,} \PY{l+m+mf}{0.225}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} TODO: Load the datasets with ImageFolder}
        \PY{n}{train\PYZus{}datasets} \PY{o}{=} \PY{n}{datasets}\PY{o}{.}\PY{n}{ImageFolder}\PY{p}{(}\PY{n}{train\PYZus{}dir}\PY{p}{,} \PY{n}{transform}\PY{o}{=}\PY{n}{train\PYZus{}transforms}\PY{p}{)}
        \PY{n}{test\PYZus{}datasets} \PY{o}{=} \PY{n}{datasets}\PY{o}{.}\PY{n}{ImageFolder}\PY{p}{(}\PY{n}{test\PYZus{}dir}\PY{p}{,} \PY{n}{transform}\PY{o}{=}\PY{n}{test\PYZus{}transforms}\PY{p}{)}
        \PY{n}{valid\PYZus{}datasets} \PY{o}{=} \PY{n}{datasets}\PY{o}{.}\PY{n}{ImageFolder}\PY{p}{(}\PY{n}{valid\PYZus{}dir}\PY{p}{,} \PY{n}{transform}\PY{o}{=}\PY{n}{valid\PYZus{}transforms}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} TODO: Using the image datasets and the trainforms, define the dataloaders}
        \PY{n}{trainloader} \PY{o}{=} \PY{n}{torch}\PY{o}{.}\PY{n}{utils}\PY{o}{.}\PY{n}{data}\PY{o}{.}\PY{n}{DataLoader}\PY{p}{(}\PY{n}{train\PYZus{}datasets}\PY{p}{,} \PY{n}{batch\PYZus{}size}\PY{o}{=}\PY{l+m+mi}{32}\PY{p}{,} \PY{n}{shuffle}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
        \PY{n}{testloader} \PY{o}{=} \PY{n}{torch}\PY{o}{.}\PY{n}{utils}\PY{o}{.}\PY{n}{data}\PY{o}{.}\PY{n}{DataLoader}\PY{p}{(}\PY{n}{test\PYZus{}datasets}\PY{p}{,} \PY{n}{batch\PYZus{}size}\PY{o}{=}\PY{l+m+mi}{32}\PY{p}{)}
        \PY{n}{validloader} \PY{o}{=} \PY{n}{torch}\PY{o}{.}\PY{n}{utils}\PY{o}{.}\PY{n}{data}\PY{o}{.}\PY{n}{DataLoader}\PY{p}{(}\PY{n}{valid\PYZus{}datasets}\PY{p}{,} \PY{n}{batch\PYZus{}size}\PY{o}{=}\PY{l+m+mi}{32}\PY{p}{)}
\end{Verbatim}


    \hypertarget{label-mapping}{%
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{cat\PYZus{}to\PYZus{}name}
\end{Verbatim}
...
in the next part of the project.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} load pretrained model}
        \PY{n}{net} \PY{o}{=} \PY{n}{models}\PY{o}{.}\PY{n}{vgg16}\PY{p}{(}\PY{n}{pretrained}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} freeze features in pretrained model (no backprop)}
        ...
        \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}classifier = nn.Sequential(OrderedDict([(\PYZsq{}fc1\PYZsq{}, nn.Linear(25088, 15000)), (\PYZsq{}relu\PYZsq{}, nn.ReLU(inplace=True)),}
        \PY{l+s+sd}{                                        (\PYZsq{}dropout\PYZsq{}, nn.Dropout(p=0.5)), (\PYZsq{}fc2\PYZsq{}, nn.Linear(15000, 10000)), }
        \PY{l+s+sd}{                                        (\PYZsq{}relu1\PYZsq{}, nn.ReLU(inplace=True)),(\PYZsq{}dropout1\PYZsq{}, nn.Dropout(p=0.5)), }
        \PY{l+s+sd}{                                        (\PYZsq{}fc3\PYZsq{}, nn.Linear(10000, 4096)), (\PYZsq{}relu2\PYZsq{}, nn.ReLU(inplace=True)), }
        \PY{l+s+sd}{                                        (\PYZsq{}dropout2\PYZsq{}, nn.Dropout(p=0.5)), (\PYZsq{}fc4\PYZsq{}, nn.Linear(4096, 1000)), }
        \PY{l+s+sd}{                                        (\PYZsq{}relu3\PYZsq{}, nn.ReLU(inplace=True)), (\PYZsq{}dropout3\PYZsq{}, nn.Dropout(p=0.5)), }
        \PY{l+s+sd}{                                        (\PYZsq{}fc5\PYZsq{}, nn.Linear(1000, 102)), (\PYZsq{}output\PYZsq{}, nn.LogSoftmax(dim=1))])) \PYZsh{}change if needed}
        \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
        \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}classifier = nn.Sequential(OrderedDict([(\PYZsq{}fc1\PYZsq{}, nn.Linear(25088, 1024)), (\PYZsq{}relu1\PYZsq{}, nn.ReLU(inplace=True)), }
        \PY{l+s+sd}{                                        (\PYZsq{}dropout1\PYZsq{}, nn.Dropout(p=0.5)), (\PYZsq{}fc2\PYZsq{}, nn.Linear(1024, 1024)), }
        \PY{l+s+sd}{                                        (\PYZsq{}relu2\PYZsq{}, nn.ReLU(inplace=True)), (\PYZsq{}dropout2\PYZsq{}, nn.Dropout(p=0.5)), }
        \PY{l+s+sd}{                                        (\PYZsq{}fc3\PYZsq{}, nn.Linear(1024, 102)), (\PYZsq{}output\PYZsq{}, nn.LogSoftmax(dim=1))]))}
        \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
        \PY{c+c1}{\PYZsh{} create new classifier}
        \PY{n}{classifier} \PY{o}{=} \PY{n}{nn}\PY{o}{.}\PY{n}{Sequential}\PY{p}{(}\PY{n}{OrderedDict}\PY{p}{(}\PY{p}{[}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{fc1}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{nn}\PY{o}{.}\PY{n}{Linear}\PY{p}{(}\PY{l+m+mi}{25088}\PY{p}{,} \PY{l+m+mi}{1024}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{relu1}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{nn}\PY{o}{.}\PY{n}{ReLU}\PY{p}{(}\PY{n}{inplace}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}\PY{p}{)}\PY{p}{,} 
                                                \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{dropout1}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{nn}\PY{o}{.}\PY{n}{Dropout}\PY{p}{(}\PY{n}{p}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{fc2}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{nn}\PY{o}{.}\PY{n}{Linear}\PY{p}{(}\PY{l+m+mi}{1024}\PY{p}{,} \PY{l+m+mi}{102}\PY{p}{)}\PY{p}{)}\PY{p}{,} 
                                                \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{output}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{nn}\PY{o}{.}\PY{n}{LogSoftmax}\PY{p}{(}\PY{n}{dim}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}\PY{p}{]}\PY{p}{)}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} assign classifier to pretrained vgg16 model}
        \PY{n}{net}\PY{o}{.}\PY{n}{classifier} \PY{o}{=} \PY{n}{classifier}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{net}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} define network parameters}
        \PY{n}{learnrate} \PY{o}{=} \PY{l+m+mf}{0.001} 
        
        \PY{n}{criterion} \PY{o}{=} \PY{n}{nn}\PY{o}{.}\PY{n}{NLLLoss}\PY{p}{(}\PY{p}{)} 
        \PY{n}{optimizer} \PY{o}{=} \PY{n}{optim}\PY{o}{.}\PY{n}{Adam}\PY{p}{(}\PY{n}{net}\PY{o}{.}\PY{n}{classifier}\PY{o}{.}\PY{n}{parameters}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{lr}\PY{o}{=}\PY{n}{learnrate}\PY{p}{)} 
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} train classifier}
        \PY{n}{cuda} \PY{o}{=} \PY{n}{torch}\PY{o}{.}\PY{n}{cuda}\PY{o}{.}\PY{n}{is\PYZus{}available}\PY{p}{(}\PY{p}{)}
        \PY{k}{if} \PY{n}{cuda}\PY{p}{:}
            \PY{n}{net} \PY{o}{=} \PY{n}{net}\PY{o}{.}\PY{n}{cuda}\PY{p}{(}\PY{p}{)}
        \PY{k}{else}\PY{p}{:}
            \PY{n}{net} \PY{o}{=} \PY{n}{net}\PY{o}{.}\PY{n}{cpu}\PY{p}{(}\PY{p}{)}
        
        \PY{n}{epochs} \PY{o}{=} \PY{l+m+mi}{3}
        \PY{n}{print\PYZus{}every} \PY{o}{=} \PY{l+m+mi}{40}
        ...
        \PY{k}{for} \PY{n}{e} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{epochs}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{running\PYZus{}loss} \PY{o}{=} \PY{l+m+mi}{0}
            ...
            \PY{k}{for} \PY{n}{ii}\PY{p}{,} \PY{p}{(}\PY{n}{images}\PY{p}{,} \PY{n}{labels}\PY{p}{)} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{trainloader}\PY{p}{)}\PY{p}{:}
                ...
                \PY{n}{inputs}\PY{p}{,} \PY{n}{labels} \PY{o}{=} \PY{n}{Variable}\PY{p}{(}\PY{n}{images}\PY{p}{)}\PY{p}{,} \PY{n}{Variable}\PY{p}{(}\PY{n}{labels}\PY{p}{)}
                ...
                \PY{k}{else}\PY{p}{:}
                    \PY{n}{inputs}\PY{p}{,} \PY{n}{labels} \PY{o}{=} \PY{n}{inputs}\PY{o}{.}\PY{n}{cpu}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{labels}\PY{o}{.}\PY{n}{cpu}\PY{p}{(}\PY{p}{)}
        
                \PY{n}{outputs} \PY{o}{=} \PY{n}{net}\PY{o}{.}\PY{n}{forward}\PY{p}{(}\PY{n}{inputs}\PY{p}{)}
                ...
                \PY{k}{if} \PY{n}{steps} \PY{o}{\PYZpc{}} \PY{n}{print\PYZus{}every} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{:}
                    ...
                    \PY{k}{for} \PY{n}{ii}\PY{p}{,} \PY{p}{(}\PY{n}{images}\PY{p}{,} \PY{n}{labels}\PY{p}{)} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{validloader}\PY{p}{)}\PY{p}{:}
                        
                        \PY{n}{inputs} \PY{o}{=} \PY{n}{Variable}\PY{p}{(}\PY{n}{images}\PY{p}{,} \PY{n}{volatile}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
                        \PY{n}{labels} \PY{o}{=} \PY{n}{Variable}\PY{p}{(}\PY{n}{labels}\PY{p}{,} \PY{n}{volatile}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
                        ...
                        \PY{n}{output} \PY{o}{=} \PY{n}{net}\PY{o}{.}\PY{n}{forward}\PY{p}{(}\PY{n}{inputs}\PY{p}{)}
                        \PY{n}{test\PYZus{}loss} \PY{o}{+}\PY{o}{=} \PY{n}{criterion}\PY{p}{(}\PY{n}{output}\PY{p}{,} \PY{n}{labels}\PY{p}{)}\PY{o}{.}\PY{n}{data}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
                        
                        \PY{n}{ps} \PY{o}{=} \PY{n}{torch}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{n}{output}\PY{p}{)}\PY{o}{.}\PY{n}{data}
                        \PY{c+c1}{\PYZsh{}ps = output.data}
                        
                        \PY{n}{equality} \PY{o}{=} \PY{p}{(}\PY{n}{labels}\PY{o}{.}\PY{n}{data} \PY{o}{==} \PY{n}{ps}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
                        
                        \PY{n}{accuracy} \PY{o}{+}\PY{o}{=} \PY{n}{equality}\PY{o}{.}\PY{n}{type\PYZus{}as}\PY{p}{(}\PY{n}{torch}\PY{o}{.}\PY{n}{FloatTensor}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{)}
                    ...
                    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Epoch: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{/}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{.. }\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{e}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{epochs}\PY{p}{)}\PY{p}{,}
                      \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Training Loss: }\PY{l+s+si}{\PYZob{}:.3f\PYZcb{}}\PY{l+s+s2}{.. }\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{running\PYZus{}loss}\PY{o}{/}\PY{n}{print\PYZus{}every}\PY{p}{)}\PY{p}{,}
                      \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Test Loss: }\PY{l+s+si}{\PYZob{}:.3f\PYZcb{}}\PY{l+s+s2}{.. }\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{test\PYZus{}loss}\PY{o}{/}\PY{n+nb}{len}\PY{p}{(}\PY{n}{validloader}\PY{p}{)}\PY{p}{)}\PY{p}{,}
                      \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Test Accuracy: }\PY{l+s+si}{\PYZob{}:.3f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{accuracy}\PY{o}{/}\PY{n+nb}{len}\PY{p}{(}\PY{n}{validloader}\PY{p}{)}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \hypertarget{testing-your-network}{%
\subsection{Testing your network}\label{testing-your-network}}
...
around 70\% accuracy on the test set if the model has been trained well.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} TODO: Do validation on the test set}
        \PY{n}{net}\PY{o}{.}\PY{n}{eval}\PY{p}{(}\PY{p}{)}
        ...
        \PY{k}{else}\PY{p}{:}
            \PY{n}{net}\PY{o}{.}\PY{n}{cpu}\PY{p}{(}\PY{p}{)}
        
        \PY{n}{accuracy} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{n}{test\PYZus{}loss} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{k}{for} \PY{n}{ii}\PY{p}{,} \PY{p}{(}\PY{n}{images}\PY{p}{,} \PY{n}{labels}\PY{p}{)} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{testloader}\PY{p}{)}\PY{p}{:}
            \PY{c+c1}{\PYZsh{}images = images.resize\PYZus{}(images.size()[0], 784)}
            ...
            \PY{n+nb}{print} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Test Accuracy: }\PY{l+s+si}{\PYZob{}:.3f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{accuracy}\PY{o}{/}\PY{n+nb}{len}\PY{p}{(}\PY{n}{testloader}\PY{p}{)}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
model in the next part of the project, so best to save it now.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} TODO: Save the checkpoint }
        \PY{n}{net}\PY{o}{.}\PY{n}{class\PYZus{}to\PYZus{}idx} \PY{o}{=} \PY{n}{train\PYZus{}datasets}\PY{o}{.}\PY{n}{class\PYZus{}to\PYZus{}idx} 
        
        \PY{c+c1}{\PYZsh{}checkpoint = \PYZob{}\PYZsq{}input\PYZus{}size\PYZsq{}: 224*224, \PYZsq{}output\PYZus{}size\PYZsq{}: 102, \PYZsq{}features\PYZsq{}: [each.out\PYZus{}features for each in net.features],\PYZsq{}classifier\PYZsq{}: [each.out\PYZus{}features for each in net.classifier], \PYZsq{}state\PYZus{}dict\PYZsq{}: net.state\PYZus{}dict(), \PYZsq{}optimizer\PYZsq{}: optimizer.state\PYZus{}dict(), \PYZsq{}mapping\PYZsq{}: net.class\PYZus{}to\PYZus{}idx\PYZcb{}}
        \PY{n}{checkpoint} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{features}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{net}\PY{o}{.}\PY{n}{features}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{classifier}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{net}\PY{o}{.}\PY{n}{classifier}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{state\PYZus{}dict}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{net}\PY{o}{.}\PY{n}{state\PYZus{}dict}\PY{p}{(}\PY{p}{)}\PY{p}{,} 
                      \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{optimizer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{optimizer}\PY{o}{.}\PY{n}{state\PYZus{}dict}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{epochs}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{epochs}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{class\PYZus{}to\PYZus{}idx}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{net}\PY{o}{.}\PY{n}{class\PYZus{}to\PYZus{}idx}\PY{p}{\PYZcb{}}
        
        \PY{n}{torch}\PY{o}{.}\PY{n}{save}\PY{p}{(}\PY{n}{checkpoint}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{checkpoint.pth}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{net}\PY{o}{.}\PY{n}{state\PYZus{}dict}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}\PY{p}{)}
\end{Verbatim}


    \hypertarget{loading-the-checkpoint}{%
...
keep working on it without having to retrain the network.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{} TODO: Write a function that loads a checkpoint and rebuilds the model}
        \PY{k}{def} \PY{n+nf}{load\PYZus{}checkpoint}\PY{p}{(}\PY{n}{filepath}\PY{p}{)}\PY{p}{:}
                
            \PY{n}{checkpoint} \PY{o}{=} \PY{n}{torch}\PY{o}{.}\PY{n}{load}\PY{p}{(}\PY{n}{filepath}\PY{p}{,} \PY{n}{map\PYZus{}location}\PY{o}{=}\PY{k}{lambda} \PY{n}{storage}\PY{p}{,} \PY{n}{loc}\PY{p}{:} \PY{n}{storage}\PY{p}{)}
            
            \PY{n}{model} \PY{o}{=} \PY{n}{nn}\PY{o}{.}\PY{n}{Sequential}\PY{p}{(}\PY{p}{)}
            
            \PY{n}{model}\PY{o}{.}\PY{n}{features} \PY{o}{=} \PY{n}{checkpoint}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{features}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
            \PY{n}{model}\PY{o}{.}\PY{n}{classifier} \PY{o}{=} \PY{n}{checkpoint}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{classifier}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
            ...
            \PY{n}{model}\PY{o}{.}\PY{n}{class\PYZus{}to\PYZus{}idx} \PY{o}{=} \PY{n}{checkpoint}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{class\PYZus{}to\PYZus{}idx}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
            \PY{n}{model}\PY{o}{.}\PY{n}{optimizer} \PY{o}{=} \PY{n}{checkpoint}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{optimizer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
            \PY{n}{model}\PY{o}{.}\PY{n}{epochs} \PY{o}{=} \PY{n}{checkpoint}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{epochs}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{model} \PY{o}{=} \PY{n}{load\PYZus{}checkpoint}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{checkpoint.pth}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{model}\PY{o}{.}\PY{n}{state\PYZus{}dict}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}
        \PY{n}{model}\PY{o}{.}\PY{n}{class\PYZus{}to\PYZus{}idx}
\end{Verbatim}


    \hypertarget{inference-for-classification}{%
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{def} \PY{n+nf}{process\PYZus{}image}\PY{p}{(}\PY{n}{image}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
            ...
            \PY{c+c1}{\PYZsh{} TODO: Process a PIL image for use in a PyTorch model}
            
            \PY{n}{size} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{size}
            \PY{k}{if} \PY{n}{size}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{\PYZgt{}} \PY{n}{size}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{:}
                \PY{n}{short}\PY{p}{,} \PY{n}{long} \PY{o}{=} \PY{n}{size}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{size}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{k}{else}\PY{p}{:}
                \PY{n}{short}\PY{p}{,} \PY{n}{long} \PY{o}{=} \PY{n}{size}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{size}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{c+c1}{\PYZsh{} RESIZE    }
            \PY{n}{new\PYZus{}short} \PY{o}{=} \PY{l+m+mi}{256}
            \PY{n}{new\PYZus{}long} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{256}\PY{o}{/}\PY{n}{size}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{o}{*}\PY{n}{size}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
            \PY{n}{img} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{resize}\PY{p}{(}\PY{p}{(}\PY{n}{new\PYZus{}short}\PY{p}{,} \PY{n}{new\PYZus{}long}\PY{p}{)}\PY{p}{)}
            \PY{c+c1}{\PYZsh{} CENTERCROP}
            \PY{n}{area} \PY{o}{=} \PY{p}{(}\PY{p}{(}\PY{n}{new\PYZus{}short}\PY{o}{\PYZhy{}}\PY{l+m+mi}{224}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{,} \PY{p}{(}\PY{n}{new\PYZus{}long}\PY{o}{\PYZhy{}}\PY{l+m+mi}{224}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{224}\PY{p}{,} \PY{l+m+mi}{224}\PY{p}{)}
            \PY{n}{img} \PY{o}{=} \PY{n}{img}\PY{o}{.}\PY{n}{crop}\PY{p}{(}\PY{n}{area}\PY{p}{)}
            \PY{c+c1}{\PYZsh{} NORMALISE COLOR CHANNELS}
            \PY{n}{np\PYZus{}image} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{img}\PY{p}{)}
            
            \PY{n}{means} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{0.485}\PY{p}{,} \PY{l+m+mf}{0.456}\PY{p}{,} \PY{l+m+mf}{0.406}\PY{p}{]}\PY{p}{)}
            \PY{n}{stds} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{0.229}\PY{p}{,} \PY{l+m+mf}{0.224}\PY{p}{,} \PY{l+m+mf}{0.225}\PY{p}{]}\PY{p}{)}
            
            \PY{n}{np\PYZus{}image} \PY{o}{=} \PY{p}{(}\PY{n}{np\PYZus{}image}\PY{o}{/}\PY{l+m+mi}{255} \PY{o}{\PYZhy{}} \PY{n}{means}\PY{p}{)} \PY{o}{/} \PY{n}{stds}
            \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}    }
        \PY{l+s+sd}{    for w in np\PYZus{}image:}
        \PY{l+s+sd}{        for h in np\PYZus{}image[w]:}
        \PY{l+s+sd}{            np\PYZus{}image[w][h] = (np\PYZus{}image[w][h]/255 \PYZhy{} means)/stds}
        \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
            
            \PY{c+c1}{\PYZsh{} TRANSPOSE IMAGE}
            \PY{n}{img\PYZus{}tp} \PY{o}{=} \PY{n}{np\PYZus{}image}\PY{o}{.}\PY{n}{transpose}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
            
            \PY{k}{return} \PY{n}{img\PYZus{}tp}
\end{Verbatim}
...
original image (except for the cropped out portions).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{def} \PY{n+nf}{imshow}\PY{p}{(}\PY{n}{image}\PY{p}{,} \PY{n}{ax}\PY{o}{=}\PY{k+kc}{None}\PY{p}{,} \PY{n}{title}\PY{o}{=}\PY{k+kc}{None}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{image} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{transpose}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{\PYZsh{} test process\PYZus{}image function}
         \PY{n}{data\PYZus{}dir} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{flowers}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{directory} \PY{o}{=} \PY{n}{data\PYZus{}dir} \PY{o}{+} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/train}\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/10}\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/image\PYZus{}07086.jpg}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{image} \PY{o}{=} \PY{n}{Image}\PY{o}{.}\PY{n}{open}\PY{p}{(}\PY{n}{directory}\PY{p}{)}
         \PY{n}{img} \PY{o}{=} \PY{n}{process\PYZus{}image}\PY{p}{(}\PY{n}{image}\PY{p}{)}
...
\end{Shaded}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{k}{def} \PY{n+nf}{predict}\PY{p}{(}\PY{n}{image\PYZus{}path}\PY{p}{,} \PY{n}{model}\PY{p}{,} \PY{n}{topk}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
             ...
             \PY{c+c1}{\PYZsh{}model = load\PYZus{}checkpoint(model)}
             \PY{n}{image} \PY{o}{=} \PY{n}{Image}\PY{o}{.}\PY{n}{open}\PY{p}{(}\PY{n}{image\PYZus{}path}\PY{p}{)}
             \PY{n}{img} \PY{o}{=} \PY{n}{process\PYZus{}image}\PY{p}{(}\PY{n}{image}\PY{p}{)}
             \PY{n}{imgT} \PY{o}{=} \PY{n}{torch}\PY{o}{.}\PY{n}{from\PYZus{}numpy}\PY{p}{(}\PY{n}{img}\PY{p}{)}
             \PY{n+nb}{print} \PY{p}{(}\PY{n}{imgT}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
             \PY{n}{model}\PY{o}{.}\PY{n}{eval}\PY{p}{(}\PY{p}{)}
             
             \PY{n}{output} \PY{o}{=} \PY{n}{model}\PY{o}{.}\PY{n}{forward}\PY{p}{(}\PY{n}{Variable}\PY{p}{(}\PY{n}{imgT}\PY{p}{,} \PY{n}{volatile}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}\PY{p}{)}
             \PY{n}{ps} \PY{o}{=} \PY{n}{torch}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{n}{output}\PY{p}{)}
             
             \PY{c+c1}{\PYZsh{} topK classes and probabilities }
             \PY{n}{probs}\PY{p}{,} \PY{n}{indices} \PY{o}{=} \PY{n}{torch}\PY{o}{.}\PY{n}{topk}\PY{p}{(}\PY{n}{ps}\PY{p}{,} \PY{n}{topk}\PY{p}{)}
             
             \PY{c+c1}{\PYZsh{} invert class\PYZus{}to\PYZus{}idx dict}
             \PY{n}{idx\PYZus{}to\PYZus{}class} \PY{o}{=} \PY{p}{\PYZob{}}\PY{n}{i}\PY{p}{:}\PY{n}{c} \PY{k}{for} \PY{n}{c}\PY{p}{,}\PY{n}{i} \PY{o+ow}{in} \PY{n}{model}\PY{o}{.}\PY{n}{class\PYZus{}to\PYZus{}idx}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{\PYZcb{}}
             \PY{n}{classes} \PY{o}{=} \PY{p}{\PYZob{}}\PY{n}{idx\PYZus{}to\PYZus{}class}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{indices}\PY{p}{\PYZcb{}}
             
             \PY{k}{return} \PY{n}{probs}\PY{p}{,} \PY{n}{classes}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{predict}\PY{p}{(}\PY{n}{directory}\PY{p}{,} \PY{n}{model}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}
\end{Verbatim}
...
/opt/conda/lib/python3.6/site-packages/ipykernel\_launcher.py:12: UserWarning: volatile was removed and now has no effect. Use `with torch.no\_grad():` instead.
  if sys.path[0] == '':
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{imgT}
\end{Verbatim}


    \hypertarget{sanity-checking}{%
...
to check that there aren't obvious bugs. Use \texttt{matplotlib} to plot
the probabilities for the top 5 classes as a bar graph, along with the
